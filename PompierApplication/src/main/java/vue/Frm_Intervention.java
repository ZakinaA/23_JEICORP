 ...
 */
public class Frm_Intervention extends javax.swing.JFrame {

    /**
     * Creates new form connexion
     */
    public Frm_Intervention() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Intervention.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Intervention().setVisible(true);
            }
        });
    }
