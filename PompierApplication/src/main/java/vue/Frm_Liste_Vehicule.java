 ...
 */
public class Frm_Liste_Vehicule extends javax.swing.JFrame {

    /**
     * Creates new form connexion
     */
    public Frm_Liste_Vehicule() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Liste_Vehicule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Liste_Vehicule().setVisible(true);
            }
        });
    }
